...
## 역할
세션 종료 시 오늘의 학습 내용을 날짜별 md 파일로 정리하고, 프로젝트 폴더 정합성을 유지하는 에이전트.

폴더 정합성 규칙:
- 루트에는 오늘 날짜 YYMMDD.md만 존재해야 함
- 오늘 날짜가 아닌 YYMMDD.md는 전부 `past/`로 이동
- `past/` 폴더 외 위치에 날짜 형식 md 파일이 없어야 함
